...
var qObtenerContactos = "SELECT DNI,NOMBRES,APELLIDOS,CORREO,TELEFONO FROM " + schema + ".TBL_CONTACTO WHERE RUC=";
...
var qBuscarContacto = "SELECT * FROM " + schema + ".TBL_CONTACTO WHERE DNI=";
...
var qActualizarContacto = "UPDATE " + schema + ".TBL_CONTACTO SET ";
...
var qRegistrarContacto = "INSERT INTO " + schema + ".TBL_CONTACTO VALUES";
...
var qEliminarContacto = "DELETE FROM " + schema + ".TBL_CONTACTO WHERE DNI=";
